(function(c){var b=function(d,e){
    ...
    c.fn.filestyle.defaults={buttonText:"",iconName:"fa fa-image",buttonName:"btn-default",size:"nr",input:true,badge:true,icon:true,buttonBefore:false,disabled:false};
